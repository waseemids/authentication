...
class ProcessorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->_processor = new Processor($this->getMock('\SoampliApps\Authentication\SettingsProviderInterface'), null, array());
    ...
    public function testConstructor()
    {
        ...
        $processor = new Processor($this->getMock('\SoampliApps\Authentication\SettingsProviderInterface'), null, $post_data);
        $class = new \ReflectionClass("\SoampliApps\Authentication\Processor");
    ...
    /**
     * @covers SoampliApps\Authentication\Processor::checkForAuthentication
     */
    public function testCheckForAuthentication()
    {
        $processor = $this->getMockBuilder('\SoampliApps\Authentication\Processor')
        ...
        $user_gateway = $this->getMock('\SoampliApps\Authentication\UserGateway');
        $user_gateway->user = new \stdClass();

        $settings = $this->getMock('\SoampliApps\Authentication\SettingsProviderInterface');
    ...
    /**
     * @covers \SoampliApps\Authentication\Processor::attemptToLogin
     * @covers \SoampliApps\Authentication\Processor::authenticateFromUserId
     */
    public function testLoggingIn()
    {
        ...
        $session_provider = $this->getMock('\SoampliApps\Authentication\Providers\ProviderInterface');
        $session_provider->expects($this->once())
                         ->method('hasAttemptedToLoginWithProvider')
                         ->will($this->returnValue(false));

        $session_provider_2 = $this->getMock('\SoampliApps\Authentication\Providers\ProviderInterface');
        ...
        $settings_provider = $this->getMock('\SoampliApps\Authentication\SettingsProviderInterface');
    ...
    public function testGetUser()
    {
        ...
        $processor = new \SoampliApps\Authentication\Processor($settings);
        $this->assertEquals($user, $processor->getUser());
    }
    ...
    public function testUserWantsToBeRemembered()
    {
        ...
        $processor = new \SoampliApps\Authentication\Processor($this->getMock('\SoampliApps\Authentication\SettingsProviderInterface'), $this->_container);
    ...
    {
        $session_provider = $this->getMock('\SoampliApps\Authentication\Providers\PersistantProviderInterface');
        $session_provider->expects($this->once())
                         ->method('persistLogin');
    ...
    public function testRememberUser()
    {
        ...
        $session_provider_3 = $this->getMock('\SoampliApps\Authentication\Providers\CookiePersistantProviderInterface');
    ...
    public function testManualLogin()
    {
        ...
        $reflection = new \ReflectionClass('\SoampliApps\Authentication\Processor');
    ...
    /**
     * @covers SoampliApps\Authentication\Processor::shouldPersist
     */
    public function testShouldPersist()
    {
        ...
        $provider = $this->getMock('\SoampliApps\Authentication\Providers\ProviderInterface');
        $provider->expects($this->once())
                 ->method('shouldPersist')
                 ->will($this->returnValue(false));
        $this->_container->insert($provider,0);
        $processor->__construct($this->getMock('\SoampliApps\Authentication\SettingsProviderInterface'), $this->_container);
