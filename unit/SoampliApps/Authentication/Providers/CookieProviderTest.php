...
class CookieProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->_userFactory = $this->getMock('\SoampliApps\Authentication\UserFactoryInterface');
        $this->object = $this->getMockBuilder('\SoampliApps\Authentication\Providers\CookieProvider')
    ...
    public function testSetCookieValues()
    {
        ...
        $class = new \ReflectionClass("\SoampliApps\Authentication\Providers\CookieProvider");
