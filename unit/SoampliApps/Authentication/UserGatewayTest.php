...
class UserGatewayTest extends \PHPUnit_Framework_TestCase
{
    public function setUp()
    {
        ...
        $this->_stub = $this->getMock('\SoampliApps\Authentication\UserInterface');
    }

    public function testSetUserIdCookieName()
    {
        $reflection = new \ReflectionClass('\SoampliApps\Authentication\UserGateway');
    ...
    /**
     * @covers SoampliApps\Authentication\UserGateway::getCookieValues
     */
